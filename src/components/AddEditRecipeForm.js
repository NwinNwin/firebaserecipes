    ...
    <form onSubmit={handleRecipeFormSubmit} className="add-edit-recipe-form-container">
        ...
        <div className="fields">
          ...
          <label className="recipe-label input-label">
            ...
            <select value={category} onChange={(e) => setCategory(e.target.value)} className="select" required>
              ...
              <option value="dessertsAndBakedGoods">Dessert and Baked Goods</option>
          ...
          <label className="recipe-label input-label">
            Directions:
            <textarea className="input-text" required value={directions} onChange={(e) => setDirections(e.target.value)}></textarea>
          </label>

          <label className="recipe-label input-label">
            Publish Dates:
            <input className="input-text" type="date" required value={publishDate} onChange={(e) => setDirections(e.target.value)} />
          </label>
        </div>
      </div>
      ...
      <div className="ingredients-list">
        ...
        <div className="ingredient-form">
          ...
          <button className="primary-button add-ingredient-button" onClick={handleAddIngredient}>
            Add Ingredients
          </button>
        </div>
      </div>
